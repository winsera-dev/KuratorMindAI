...
Use template from `/Users/muflihiskandar/Products - Winsera/kuratormind-ai/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/muflihiskandar/Products - Winsera/kuratormind-ai/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/muflihiskandar/Products - Winsera/kuratormind-ai/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
