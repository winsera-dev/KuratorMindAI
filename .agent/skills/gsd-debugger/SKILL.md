...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/muflihiskandar/Products - Winsera/kuratormind-ai/.gemini
                  → checks /Users/muflihiskandar/Products - Winsera/kuratormind-ai/.gemini/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/muflihiskandar/Products - Winsera/kuratormind-ai/.gemini/get-shit-done
                  → writes to /Users/muflihiskandar/Products - Winsera/kuratormind-ai/.gemini/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/muflihiskandar/Products - Winsera/kuratormind-ai/.gemini/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/muflihiskandar/Products - Winsera/kuratormind-ai/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/muflihiskandar/Products - Winsera/kuratormind-ai/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
