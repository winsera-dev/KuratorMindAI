...
- Usage: Reference from command with `@/Users/muflihiskandar/Products - Winsera/kuratormind-ai/.agent/skills/gsd/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/muflihiskandar/Products - Winsera/kuratormind-ai/.agent/skills/gsd/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/muflihiskandar/Products - Winsera/kuratormind-ai/.agent/skills/gsd/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
