...
- **Global scope**: `/Users/muflihiskandar/Products - Winsera/kuratormind-ai/.agent/skills/gsd/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/muflihiskandar/Products - Winsera/kuratormind-ai/.agent/skills/gsd/notes/`)
...
2. Glob `/Users/muflihiskandar/Products - Winsera/kuratormind-ai/.agent/skills/gsd/notes/*.md` (if directory exists) — global notes
...
Global (/Users/muflihiskandar/Products - Winsera/kuratormind-ai/.agent/skills/gsd/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/muflihiskandar/Products - Winsera/kuratormind-ai/.agent/skills/gsd/notes/` — works in any directory
